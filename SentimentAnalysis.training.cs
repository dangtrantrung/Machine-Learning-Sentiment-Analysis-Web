...
namespace SentimentRazor
{
    ...
    {
        public const string RetrainFilePath =  @"C:\Users\artminh\Downloads\wikipedia-detox-250-line-data.tsv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Categorical.OneHotEncoding(@"LoggedIn", @"LoggedIn", outputKind: OneHotEncodingEstimator.OutputKind.Indicator)      
                                    ...
                                    .Append(mlContext.MulticlassClassification.Trainers.OneVersusAll(binaryEstimator:mlContext.BinaryClassification.Trainers.FastForest(new FastForestBinaryTrainer.Options(){NumberOfTrees=4,NumberOfLeaves=4,FeatureFraction=0.9847249F,LabelColumnName=@"Sentiment",FeatureColumnName=@"Features"}),labelColumnName:@"Sentiment"))      
